...
class Family(family.Family):
    def __init__(self):
        ...
        self.namespaces[11]['or'] = [u'ଛାଞ୍ଚ ଆଲୋଚନା', u'ଟେଁପଲେଟ ଆଲୋଚନା', u'ଟେମ୍ପଲେଟ ଆଲୋଚନା']
        self.namespaces[10]['or'] = [u'ଛାଞ୍ଚ', u'ଟେଁପଲେଟ', u'ଟେମ୍ପଲେଟ']
        self.namespaces[13]['or'] = [u'ସହଯୋଗ ଆଲୋଚନା', u'ସାହାଯ୍ୟ ଆଲୋଚନା']
        self.namespaces[12]['or'] = [u'ସହଯୋଗ', u'ସାହାଯ୍ୟ']
        self.namespaces[3]['or'] = [u'ବ୍ୟବହାରକାରୀଙ୍କ ଆଲୋଚନା', u'ବ୍ୟବହାରକାରିଁକ ଆଲୋଚନା', u'ବ୍ୟବାହାରକାରୀଙ୍କ ଆଲୋଚନା']
        self.namespaces[2]['or'] = [u'ବ୍ୟବହାରକାରୀ', u'ବ୍ୟବହାରକାରି', u'ବ୍ୟବାହାରକାରୀ']
